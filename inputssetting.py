...
class InputsSetting(ctk.CTkToplevel):
    ...
    def __init__(self, *args, **kwargs):
        ...
        #===================SelectInputFrame========================
        self.selectInputFrame.grid_rowconfigure(0, weight=1)
        self.selectInputFrame.grid_columnconfigure(0, weight=0)
        self.selectInputFrame.grid_columnconfigure(1, weight=1)
        self.selectInputLabel = ctk.CTkLabel(master=self.selectInputFrame, text="Chọn đầu đo")
        self.selectInputLabel.grid(row=0, column=0, padx=5, pady=5, sticky='new')
        self.cbSelectInput = ctk.CTkComboBox(master=self.selectInputFrame, values=["Input 1", "Input 2"], command=self.loadData)
        ...
        self.formulaLabel = ctk.CTkLabel(master=self.propertiesFrame, text="Công thức (IP1, IP2)")
        self.formulaLabel.grid(row=0, column=0, padx=5, pady=5, sticky='nw')

        self.formulaStringVar = ctk.StringVar()
        self.formulaEntry = ctk.CTkEntry(master=self.propertiesFrame, textvariable=self.formulaStringVar)
        self.formulaEntry.grid(row=0, column=1, padx=5, pady=5, sticky='news')
        
        self.symbolStringVar = ctk.StringVar()
        self.symbolLabel = ctk.CTkLabel(master=self.propertiesFrame, text='Ký hiệu')
        self.symbolEntry = ctk.CTkEntry(master=self.propertiesFrame, textvariable=self.symbolStringVar)
        ...
        self.unitLabel = ctk.CTkLabel(master=self.propertiesFrame, text='Đơn vị')
        self.unitEntry = ctk.CTkEntry(master=self.propertiesFrame, textvariable=self.unitStringVar)
        ...
        self.fromLabel = ctk.CTkLabel(master=self.propertiesFrame, text='Từ (A)')
        self.fromEntry = ctk.CTkEntry(master=self.propertiesFrame, textvariable=self.fromStringVar)
        ...
        self.toLabel = ctk.CTkLabel(master=self.propertiesFrame, text='Đến (A)')
        self.toEntry = ctk.CTkEntry(master=self.propertiesFrame, textvariable=self.toStringVar)
        ...
        self.decimalPlacesLabel = ctk.CTkLabel(master=self.propertiesFrame, text='Làm tròn (x chữ số)')
        self.decimalPlacesEntry = ctk.CTkEntry(master=self.propertiesFrame, textvariable=self.decimalPlacesStringVar)
        self.decimalPlacesLabel.grid(row=5, column=0, padx=5, pady=5, sticky='nw')
        self.decimalPlacesEntry.grid(row=5, column=1, padx=5, pady=5, sticky='news')
