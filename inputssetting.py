...
class InputsSetting(ctk.CTkToplevel):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.selectInputLabel = ctk.CTkLabel(master=self.selectInputFrame, text="Chọn đầu đo",text_font=(self.TEXTFONT, -16))
        self.selectInputLabel.grid(row=0, column=0, padx=5, pady=5, sticky='new')
        self.cbSelectInput = ctk.CTkComboBox(master=self.selectInputFrame, values=["Input 1", "Input 2"], command=self.loadData,text_font=(self.TEXTFONT, -16))
        ...
        self.formulaLabel = ctk.CTkLabel(master=self.propertiesFrame, text="Công thức (IP1, IP2)",text_font=(self.TEXTFONT, -16))
        self.formulaLabel.grid(row=0, column=0, padx=5, pady=5, sticky='nw')

        self.formulaStringVar = ctk.StringVar()
        self.formulaEntry = ctk.CTkEntry(master=self.propertiesFrame, textvariable=self.formulaStringVar,text_font=(self.TEXTFONT, -16))
        self.formulaEntry.grid(row=0, column=1, padx=5, pady=5, sticky='news')
        
        self.symbolStringVar = ctk.StringVar()
        self.symbolLabel = ctk.CTkLabel(master=self.propertiesFrame, text='Ký hiệu',text_font=(self.TEXTFONT, -16))
        self.symbolEntry = ctk.CTkEntry(master=self.propertiesFrame, textvariable=self.symbolStringVar,text_font=(self.TEXTFONT, -16))
        ...
        self.unitLabel = ctk.CTkLabel(master=self.propertiesFrame, text='Đơn vị',text_font=(self.TEXTFONT, -16))
        self.unitEntry = ctk.CTkEntry(master=self.propertiesFrame, textvariable=self.unitStringVar,text_font=(self.TEXTFONT, -16))
        ...
        # self.fromEntry = ctk.CTkEntry(master=self.propertiesFrame, textvariable=self.fromStringVar,text_font=(self.TEXTFONT, -16))
        ...
        # self.toEntry = ctk.CTkEntry(master=self.propertiesFrame, textvariable=self.toStringVar,text_font=(self.TEXTFONT, -16))
        ...
        self.decimalPlacesLabel = ctk.CTkLabel(master=self.propertiesFrame, text='Làm tròn (x chữ số)',text_font=(self.TEXTFONT, -16))
        self.decimalPlacesEntry = ctk.CTkEntry(master=self.propertiesFrame, textvariable=self.decimalPlacesStringVar,text_font=(self.TEXTFONT, -16))
